        ...
        <div className={classes.heroContent}>
          <Container maxWidth="sm">
            ...
            <Typography variant="h5" align="center" color="textSecondary" paragraph>
              15 photos per page, 5 pages per search. The default search is ....dog pictures! 
            </Typography>
            <div className={classes.heroButtons}>
              <Grid container spacing={2} justify="center">
                <Grid item>
                  <SearchBar
                    onRequestSearch={(target) => handler(target)}
                  />
                  <Pagination count={5} page={currentPage} variant="outlined" shape="rounded" onChange={handler} />
                </Grid>
              </Grid>
            </div>
          </Container>
